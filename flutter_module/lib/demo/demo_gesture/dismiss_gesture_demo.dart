...
class DismissedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      body: new DismissGesture(),
    );
  }
}

class DismissGesture extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new DismissGestureState();
  }
}

class DismissGestureState extends State<DismissGesture> {
  List<String> list = [
    'A',
    'B',
    'C',
