class NetModeEntity {
	...
	NetModeEntity.fromJson(Map<String, dynamic> json) {
		if (json['result'] != null) {
			result = new List<NetModeResult>();(json['result'] as List).forEach((v) { result.add(new NetModeResult.fromJson(v)); });
		}
		code = json['code'];
...
class NetModeResult {
	...
	NetModeResult({this.country, this.piaoId, this.resEncryptionFlag, this.mvProvider, this.biaoshi, this.artistName, this.isFirstPublish, this.language, this.album10001000, this.koreanBbSong, this.picHuge, this.allRate, this.songSource, this.songId, this.album500500, this.rank, this.picPremium, this.album800800, this.info, this.area, this.siProxycompany, this.hasMvMobile, this.isNew, this.author, this.resourceType, this.hasFilmtv, this.allArtistTingUid, this.artistId, this.versions, this.publishtime, this.style, this.albumId, this.albumNo, this.resourceTypeExt, this.delStatus, this.hot, this.toneid, this.title, this.picBig, this.relateStatus, this.rankChange, this.lrclink, this.fileDuration, this.havehigh, this.charge, this.picRadio, this.learn, this.picS500, this.allArtistId, this.picSmall, this.bitrateFee, this.hasMv, this.copyType, this.tingUid, this.albumTitle});
